...
def get_char_view_keyboard(character_id: int, is_favorite: bool, page: int = 1):
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🖼 Показать больше артов", callback_data=f"more_arts:{character_id}:{page}")]
    ])
